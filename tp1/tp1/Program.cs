...
namespace tp1
{
    public class Program
    {
        ...
        Bail manoirBail = new Bail(4500, new DateTime(2019, 10, 25), new DateTime(2022, 2, 20));
        Bail manoirAppart = new Bail(1200, new DateTime(2020, 10, 25), new DateTime(2022, 2, 20));
